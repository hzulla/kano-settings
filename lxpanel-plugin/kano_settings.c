...
static gboolean show_menu(GtkWidget *widget, GdkEventButton *event)
{
    ...
    header_item = gtk_menu_item_new_with_label(_("Settings"));
    gtk_widget_set_sensitive(header_item, FALSE);
    gtk_menu_append(GTK_MENU(menu), header_item);
    gtk_widget_show(header_item);

    /* Keyboard button */
    GtkWidget* keyboard_item = gtk_image_menu_item_new_with_label(_("Keyboard"));
    ...
    /* Mouse button */
    GtkWidget* mouse_item = gtk_image_menu_item_new_with_label(_("Mouse"));
    ...
    /* Audio button */
    GtkWidget* audio_item = gtk_image_menu_item_new_with_label(_("Audio"));
    ...
    /* Display button */
    GtkWidget* display_item = gtk_image_menu_item_new_with_label(_("Display"));
    ...
    /* WiFi button */
    GtkWidget* wifi_item = gtk_image_menu_item_new_with_label(_("WiFi"));
    ...
    /* All button */
    GtkWidget* all_item = gtk_image_menu_item_new_with_label(_("All settings"));
