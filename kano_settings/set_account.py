...
class SetAccount(Gtk.Box):
    ...
    def remove_account_dialog(self, button=None):
        # Bring in message dialog box
        kdialog = kano_dialog.KanoDialog(
